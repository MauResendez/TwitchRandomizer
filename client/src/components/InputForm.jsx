            ...
            <Container component="main" maxWidth="xs" center>
              ...
              <div className={classes.paper}>
                  ...
                  <form className={classes.form} onSubmit={findRandomStream}>
                      ...
                      <TextField variant="outlined" type="number" InputProps={{ inputProps: { min: "10", max: "9999999" } }} margin="normal" fullWidth id="viewers" label="Max Number of Viewers (Minimum: 10)" name="viewers" value={viewers} onChange={e => setViewers(e.target.value)} onBlur={checkViewersInput}/>
                      <div id="inputButtons">
